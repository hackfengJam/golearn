...
CREATE TABLE `operation_log` (
                                 ...
                                 PRIMARY KEY (`id`),
                                 KEY `idx_access_key_id` (`access_key_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='AccessKey 操作记录表';


ALTER TABLE operation_log
    ADD CONSTRAINT fk_access_key_id FOREIGN KEY (access_key_id) REFERENCES access_key(id);
